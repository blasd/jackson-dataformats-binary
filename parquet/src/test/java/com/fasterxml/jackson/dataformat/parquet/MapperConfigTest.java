...
{
    private final ParquetFactory AVRO_F = new ParquetFactory();
    ...
    public void testDefaultSettingsWithObjectMapper()
    {
        ...
        _testParquetMapperDefaults(mapper);
    ...
    public void testDefaultSettingsWithParquetMapper()
    {
        ParquetMapper mapper = new ParquetMapper();
        assertNotNull(mapper.version());

        _testParquetMapperDefaults(mapper);
        _testParquetMapperDefaults(mapper.copy());
    }
    
    protected void _testParquetMapperDefaults(ObjectMapper mapper)
    {
