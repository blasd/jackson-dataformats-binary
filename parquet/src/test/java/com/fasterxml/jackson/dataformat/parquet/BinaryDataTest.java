...
import com.fasterxml.jackson.dataformat.parquet.testsupport.ThrottledInputStream;
...
public class BinaryDataTest extends AvroTestBase
{
    ...
    private final ParquetMapper AVRO_APACHE_MAPPER =  new ParquetMapper(new ApacheParquetFactory());
    ...
    public void _testAvroSchemaGenerationWithJackson(ParquetMapper mapper) throws Exception
    {
