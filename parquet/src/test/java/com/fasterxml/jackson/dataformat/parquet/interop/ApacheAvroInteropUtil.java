package com.fasterxml.jackson.dataformat.parquet.interop;
...
import com.fasterxml.jackson.dataformat.parquet.ParquetMapper;
import com.fasterxml.jackson.dataformat.parquet.testsupport.BiFunction;
import com.fasterxml.jackson.dataformat.parquet.testsupport.Function;
...
public class ApacheAvroInteropUtil {
    ...
    private static final ParquetMapper MAPPER = new ParquetMapper(new AvroModule());
