package com.fasterxml.jackson.dataformat.parquet.failing;
...
import com.fasterxml.jackson.dataformat.parquet.AvroTestBase;
...
public class AnyProperties75Test extends AvroTestBase
{
    ...
    private final ParquetMapper MAPPER = getMapper();
